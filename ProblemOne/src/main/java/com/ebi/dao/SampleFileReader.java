...
public class SampleFileReader {
     ...
     * @param attribute the key attribute name which is used to specify which
     *                  property to set in the sample object
     * @param value the value to assign for the sample object property
     ...
     */
    private void updateSampleAttribute(BioSample sample, String attribute, String value) {
        if(attribute == null) {
